...
Route::post('/admin/color/create', [App\Http\Controllers\Admin\ColorController::class, 'store'])->name('admin.color.create');
Route::post('/admin/color/update', [App\Http\Controllers\Admin\ColorController::class, 'update'])->name('admin.color.update');
Route::get('/admin/color/index', [App\Http\Controllers\Admin\ColorController::class, 'index'])->name('admin.color.index');
Route::get('/admin/color/active/{id}', [App\Http\Controllers\Admin\ColorController::class, 'active']);
Route::get('/admin/color/deactive/{id}', [App\Http\Controllers\Admin\ColorController::class, 'deactive']);
Route::get('/admin/color/edit/{id}', [App\Http\Controllers\Admin\ColorController::class, 'edit']);
Route::get('/admin/color/delete/{id}', [App\Http\Controllers\Admin\ColorController::class, 'delete']);
//Api Routes
Route::get('/get/subcategory/all/{cate_id}', [App\Http\Controllers\Api\ApiController::class, 'subcatagory']);
Route::get('/get/resubcategory/all/{resubcate_id}', [App\Http\Controllers\Api\ApiController::class, 'resubcatagory']);
