        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                        ...
                        <span class="svg-icon svg-icon-2x svg-icon-lg-3x svg-icon-primary position-absolute">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    ...
                                    <path d="M15.9497475,3.80761184 L13.0246125,6.73274681 C12.2435639,C.51379539 12.2435639,8.78012535 13.0246125,9.56117394 L14.4388261,10.9753875 C15.2198746,11.7564361 16.4862046,11.7564361 17.2672532,10.9753875 L20.1923882,8.05025253 C20.7341101,10.0447871 20.2295941,12.2556873 18.674559,13.8107223 C16.8453326,15.6399488 14.1085592,16.0155296 11.8839934,14.9444337 L6.75735931,20.0710678 C5.97631073,20.8521164 4.70998077,20.8521164 3.92893219,20.0710678 C3.1478836,19.2900192 3.1478836,18.0236893 3.92893219,17.2426407 L9.05556629,12.1160066 C7.98447038,9.89144078 8.36005124,7.15466739 10.1892777,5.32544095 C11.7443127,3.77040588 13.9552129,3.26588995 15.9497475,3.80761184 Z" fill="#000000"></path>
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Create Color</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-header card-header-stretch overflow-auto row text-right">
                           ...
                           <div class="mt-5" style="margin-left: 75px">
                                    <a href="{{ route('admin.color.index') }}" class="btn btn-primary">All Color</a>
                                </div>
                           </div>
                        </div>
                        <form class="form" method="POST" id="kt_layout_builder_form" action="{{ route('admin.color.create') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body" data-select2-id="select2-data-90-elj6">
                                <div class="tab-content pt-3" data-select2-id="select2-data-89-mk7z">
                                    <div class="tab-pane active" id="kt_builder_main" data-select2-id="select2-data-kt_builder_main">
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">Color Name:</label>
                                            <div class="col-lg-9 col-xl-4">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="text" name="color_name" placeholder="Color Name">
                                                </div>
                                                @error('color_name')
                                        ...
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">Color Code:</label>
                                            <div class="col-lg-9 col-xl-4">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid"  type="color"  name="color_code" placeholder="Color code">
                                                </div>
                                                @error('color_code')
                                                    <div class="validation">{{ $message }}</div>
                                               @enderror
