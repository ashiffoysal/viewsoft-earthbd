      ...
      <nav class="navbar navbar-light navbar-expand-lg bg-dark bg-faded osahan-menu">
         <div class="container">
            <a class="navbar-brand" href="index.html"> 
               <img src="{{asset('uploads/logo/'.$companyInformation->logo)}}" height="25px" alt="logo">EARTH BD </a>
         ...
         <div class="container">
            <div class="row">
               <div class="col-lg-3 col-md-3">
                  <h4 class="mb-5 mt-0"><a class="logo" href="index.html"><img  src="{{asset('uploads/logo/'.$companyInformation->logo)}}" height="25px" alt="EarthBD" width="150px"></a></h4>
                  <p class="mb-0"><a class="text-dark" href="#"><i class="mdi mdi-phone"></i>{{$companyInformation->mobile}}</a></p>
                  <p class="mb-0"><a class="text-dark" href="#"><i class="mdi mdi-cellphone-iphone"></i> {{$companyInformation->telephone}}</a></p>
                  <p class="mb-0"><a class="text-success" href="#"><i class="mdi mdi-email"></i> {{$companyInformation->email}}</a></p>
                  <p class="mb-0"><a class="text-primary" href="#"><i class="mdi mdi-web"></i>http://earthbd20.com</a></p>
               </div>
               ...
               <div class="col-lg-3 col-md-3">
                  ...
                  <div class="app">
                     <a href="#"><img src="{{asset('frontend/assets')}}/img/google.png" alt=""></a>
                     <a href="#"><img src="{{asset('frontend/assets')}}/img/apple.png" alt=""></a>
                  </div>
         ...
         <div class="container">
            <div class="row no-gutters">
               <div class="col-lg-6 col-sm-6">
                  <p class="mt-1 mb-0">&copy; Copyright 2022 <strong class="text-dark">Earth BD</strong>. All Rights Reserved<br>
              <small class="mt-0 mb-0">Made with <i class="mdi mdi-heart text-danger"></i> by <a href="" target="_blank" class="text-primary">ViewSoft</a>
                  </small>
              </p>
               </div>
               <div class="col-lg-6 col-sm-6 text-right">
                  <img alt="osahan logo" src="{{asset('frontend/assets')}}/img/payment_methods.png">
               </div>
            </div>
         </div>
      </section>
